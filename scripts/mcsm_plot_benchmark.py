"""
Visualise LP vs surrogate benchmark results from mcsm_benchmark.npz.

Produces plots/mcsm/benchmark_walltime.png:
...
data = np.load(RESULTS / "mcsm_benchmark.npz", allow_pickle=True)
