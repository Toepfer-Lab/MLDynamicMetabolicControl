#!/bin/bash -l
#SBATCH --job-name=test_mcsm_load
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=16gb
...
# CPLEX Python bindings for Python 3.10 (venv interpreter)
export PYTHONPATH=$PYTHONPATH:$CPLEX_HOME/python/3.10/x86-64_linux

VENV=/home/jkaatz/MA/MLDynamicMetabolicControl/.venv
SCRIPT=/home/jkaatz/MA/MLDynamicMetabolicControl/scripts/test_mcsm_load.py
